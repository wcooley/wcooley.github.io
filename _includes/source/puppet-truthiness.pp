...
notice(inline_template("<%= if @lambda; '@lambda is truthy'; else '@lambda is not truthy'; end %>"))
notice(inline_template("<%= if @empty_array; '@empty_array is truthy'; else '@empty_array is not truthy'; end %>"))
notice(inline_template("<%= if @hiera_undef; '@hiera_undef is truthy'; else '@hiera_undef is not truthy'; end %>"))
